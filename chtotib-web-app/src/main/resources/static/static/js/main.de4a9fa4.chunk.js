            ...
            return (V = Object(U.a)(M.a.mark((function e(t, n) {
                ...
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            return e.prev = 0, e.next = 3, z.a.get("http://localhost:8080/api/groups/");
                        case 3:
        ...
        function J() {
            return (J = Object(U.a)(M.a.mark((function e(t) {
                ...
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            return e.prev = 0, e.next = 3, z.a.post(" http://localhost:8080/api/groups", t);
                        case 3:
        ...
        function X() {
            return (X = Object(U.a)(M.a.mark((function e() {
                ...
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            return e.prev = 0, e.next = 3, z.a.get("http://localhost:8080/api/teachers/");
                        case 3:
            ...
            return (Q = Object(U.a)(M.a.mark((function e(t) {
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            try {
                                z.a.post("http://localhost:8080/api/lessons", t, {headers: {"Content-Type": "application/json"}}).then((function (e) {
                                    console.log(e)
                                })).catch((function (e) {
                                    console.log(e)
                                }))
                ...
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            }, (a = new FormData).append("mFile", t), e.next = 6, z.a.post("http://localhost:8080/api/import/replacements", a, n);
                        case 6:
                ...
                return M.a.wrap((function (e) {
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            ...
                            }, (a = new FormData).append("mFiles", t), e.next = 6, z.a.post("http://localhost:8080/api/import/lessons", a, n);
                        case 6:
                            return s = e.sent, e.abrupt("return", s);
                        case 10:
                            e.prev = 10, e.t0 = e.catch(0), console.error(e.t0);
...
//# sourceMappingURL=main.de4a9fa4.chunk.js.map