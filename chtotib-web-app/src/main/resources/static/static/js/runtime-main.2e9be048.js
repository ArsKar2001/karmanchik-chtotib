!function (e) {
    ...
    a.e = function (e) {
        ...
        if (0 !== t) if (t) r.push(t[2]); else {
            ...
            i.charset = "utf-8", i.timeout = 120, a.nc && i.setAttribute("nonce", a.nc), i.src = function (e) {
                return a.p + "static/js/" + ({}[e] || e) + "." + {3: "c3931084"}[e] + ".chunk.js"
            }(e);
            var c = new Error;
            u = function (r) {
    ...
    var i = this.webpackJsonpforma = this.webpackJsonpforma || [], c = i.push.bind(i);
    i.push = r, i = i.slice();
    for (var l = 0; l < i.length; l++) r(i[l]);
    var f = c;
    t()
}([]);
//# sourceMappingURL=runtime-main.2e9be048.js.map